...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <aside
        className={cn(
          'fixed lg:static inset-y-0 left-0 z-50 w-64 bg-card border-r border-border transform transition-transform duration-200 lg:transform-none',
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-border">
            <button
              ...
              className="admin-nav-item w-full text-destructive hover:bg-destructive/10 hover:text-destructive"
            >
